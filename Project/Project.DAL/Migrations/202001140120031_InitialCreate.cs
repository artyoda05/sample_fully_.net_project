    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.UserProfiles", t => t.Assigner_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Ratings", "Assigner_Id", "dbo.UserProfiles");
            DropForeignKey("dbo.Materials", "Author_Id", "dbo.UserProfiles");
            ...
            DropIndex("dbo.Ratings", new[] { "Assigner_Id" });
            ...
            DropIndex("dbo.Materials", new[] { "Author_Id" });
